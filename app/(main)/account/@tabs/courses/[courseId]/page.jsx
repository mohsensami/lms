...
const EditCourse = async ({ params: { courseId } }) => {
    ...
    return (
        <>
            {!course.active && (
                <AlertBanner label="این دوره منتشر نشده است. در دوره قابل مشاهده نخواهد بود." variant="warning" />
            )}
            <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
                    <div>
                        <div className="flex items-center gap-x-2">
                            ...
                            <h2 className="text-xl">ویرایش دوره </h2>
                        </div>
                        <TitleForm
                            initialData={{
                                title: course?.title,
                    ...
                    <div className="space-y-6">
                        <div>
                            <div className="flex items-center gap-x-2 mb-6">
                                ...
                                <h2 className="text-xl">سر فصل های دوره</h2>
                            </div>
